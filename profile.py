...
# Matches user@domain.tld — local part allows letters, digits, dots, %, +, -, _
...
def validate_profile(data: dict) -> None:
    ...
    # Matches names starting with a letter, allowing spaces, hyphens, and apostrophes between words
    ...
    age = data["age"]
    # Exclude bool since it's an int subclass but shouldn't be accepted as age
