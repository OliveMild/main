#!/usr/bin/env python3
"""Create a GitHub draft issue via the GitHub REST API."""
...
def main():
    parser = argparse.ArgumentParser(
        description="Create a GitHub draft issue via the GitHub API."
    )
    ...
    try:
        ...
        print(f"Draft issue created: {issue['html_url']}")
