...
class TestUserProfileInit:
    ...
    def test_avatar_url_with_port(self):
        p = UserProfile("alice", "Alice", "", "https://example.com:8080/avatar.png")
...
class TestProfileManagerCreate:
    ...
    def test_created_profile_attributes(self):
        profile = self.manager.create_profile("alice", "Alice", "Bio", "https://example.com/a.png")
