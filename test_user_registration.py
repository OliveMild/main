...
class TestEmailValidation:
    ...
    def test_multiple_at_signs_raises(self):
        with pytest.raises(ValidationError):
            self.registry.register("alice", "a@@example.com", "Password1")

    def test_missing_local_part_raises(self):
        with pytest.raises(ValidationError):
            self.registry.register("alice", "@example.com", "Password1")
    ...
    def test_domain_without_dot_raises(self):
        with pytest.raises(ValidationError):
            self.registry.register("alice", "alice@localhost", "Password1")
    ...
    def test_local_part_with_whitespace_raises(self):
        with pytest.raises(ValidationError):
            self.registry.register("alice", "ali ce@example.com", "Password1")

    def test_domain_with_whitespace_raises(self):
        with pytest.raises(ValidationError):
            self.registry.register("alice", "alice@exam ple.com", "Password1")
    ...
    def test_valid_email_with_subdomain(self):
        user = self.registry.register("alice", "alice@mail.example.com", "Password1")
        assert user.email == "alice@mail.example.com"

    def test_valid_email_with_plus(self):
        user = self.registry.register("alice", "alice+tag@example.com", "Password1")
...
class TestPasswordValidation:
    ...
    def test_max_length_password_accepted(self):
        ...
        password = "Password1" + "x" * (128 - 9)
        user = self.registry.register("alice", "alice@example.com", password)
