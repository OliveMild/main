...
class TestEmailValidation:
    ...
    def test_local_part_with_leading_dot_raises(self):
        with pytest.raises(ValidationError):
            self.registry.register("alice", ".alice@example.com", "Password1")

    def test_local_part_with_trailing_dot_raises(self):
        with pytest.raises(ValidationError):
            self.registry.register("alice", "alice.@example.com", "Password1")

    def test_local_part_with_consecutive_dots_raises(self):
        with pytest.raises(ValidationError):
            self.registry.register("alice", "alice..bob@example.com", "Password1")
    ...
    def test_valid_email_with_dot_in_local_part_passes(self):
        user = self.registry.register("alice", "alice.smith@example.com", "Password1")
